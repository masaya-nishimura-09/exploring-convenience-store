...
| ---- | ---------------------------------------------------- | ------------- | ---------------------------------------- | ---------- | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| 78   | ATM → 朝食、飲み物、おやつをそれぞれ 1 つずつ → レジ | 並列 Q 更新法 | ε = 0.01, Map1, similarity_threshold=0.9 | 写真で判別 | 最安値商品のみ購入。所持金不足なら購入しない。店内写真と買い物リストの写真は違う。 | 人数パラメータの違いによる結果を調査するためのプロジェクト。77からいくつか修正。 |

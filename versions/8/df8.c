...
void go_around(int store[100][100], int x, int y) {
    int last_x = x;
    int last_y = y;
    ...
    // right
    // for (y; store[last_x][y + 1] == 1 || store[last_x][y + 1] == 2; y++) {
    //     store[last_x + 1][y] = 4;
    //     last_y = y + 1;
    // }
    // last_x += 1;
